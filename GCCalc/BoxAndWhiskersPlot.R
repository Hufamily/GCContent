...
#colors <- c("red","red","red","red","red","red","red","red","red","red","red","red","red","red","red","red","red","red","red","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","yellow","green","green","green","green","green","green","green","green","green","green","green","green","green","orange","orange","orange","orange","orange","orange","orange","orange")

#conver the colors into a usable list
...
boxplot(gccontent ~ sequence, data = data, 
        main = "GC Content for Gene in Bfl,Pma,Llo,Mme,Cmu Chromosomes",
        col=colors,
        xlab = "Chromosome",
        ylab = "GC Content")

#cAvg<-setNames(c(BflChromosomes$gccontent,PmaChromosomes$gccontent,LloChromosomes$gccontent,MmeChromosomes$gccontent,CmuChromosomes$gccontent),c(BflChromosomes$name,PmaChromosomes$name,LloChromosomes$name,MmeChromosomes$name,CmuChromosomes$name))
#lines(cAvg,col="grey",type="b",pch=19)
